...
import com.bkkbnjabar.sipenting.databinding.FragmentBreastfeedingMotherRegistration1Binding
...
@AndroidEntryPoint
class BreastfeedingMotherRegistrationFragment1 : Fragment() {

    private var _binding: FragmentBreastfeedingMotherRegistration1Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBreastfeedingMotherRegistration1Binding.inflate(inflater, container, false)
        return binding.root
    }
...
//            }
        ...
        binding.etName.doAfterTextChanged { text -> viewModel.updateBreastfeedingMotherData(name = text.toString()) }
        binding.etNik.doAfterTextChanged { text -> viewModel.updateBreastfeedingMotherData(nik = text.toString()) }
        binding.etPhoneNumber.doAfterTextChanged { text -> viewModel.updateBreastfeedingMotherData(phoneNumber = text.toString()) }
        binding.etFullAddress.doAfterTextChanged { text -> viewModel.updateBreastfeedingMotherData(fullAddress = text.toString()) }
        binding.etDateOfBirth.doAfterTextChanged { text -> viewModel.updateBreastfeedingMotherData(dateOfBirth = text.toString()) }
        ...
        binding.etRw.setOnItemClickListener { adapterView, _, position, _ ->
            ...
            viewModel.updateBreastfeedingMotherData(rwId = selectedRw.id, rwName = selectedRw.name, rtId = null, rtName = null)
        ...
        binding.etRt.setOnItemClickListener { adapterView, _, position, _ ->
            ...
            viewModel.updateBreastfeedingMotherData(rtId = selectedRt.id, rtName = selectedRt.name)
        }
    ...
    private fun observeViewModel() {
        ...
        viewModel.currentBreastFeedingMother.observe(viewLifecycleOwner) { data ->
    ...
    private fun updateUiWithData(data: BreastfeedingMotherRegistrationData) {
    ...
    private fun saveUIToViewModel() {
        ...
        viewModel.updateBreastfeedingMotherData(
