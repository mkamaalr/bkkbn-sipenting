...
class ChildVisitHistoryAdapter(
    ...
    class DiffCallback : DiffUtil.ItemCallback<ChildVisitsEntity>() {
        override fun areItemsTheSame(oldItem: ChildVisitsEntity, newItem: ChildVisitsEntity) =
            oldItem.localVisitId == newItem.localVisitId

        override fun areContentsTheSame(oldItem: ChildVisitsEntity, newItem: ChildVisitsEntity) =
            oldItem == newItem
    }
}