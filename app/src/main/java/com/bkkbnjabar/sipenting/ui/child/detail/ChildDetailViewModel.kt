...
class ChildDetailViewModel @Inject constructor(
    ...
    val visitHistory: LiveData<List<ChildVisitsEntity>> = childId.switchMap { id ->
    ...
    fun calculateAllInterpretations() {
        ...
        _interpretationAge.value = interpretAge(child.dateOfBirth)
